...
const Mercury: React.FC<planets> = ({ PlanetName, PlanetAbout, PlanetImg,PlanetWikipedia,RotationTime,RevolutionTIme,Radius,Average}) => {
  ...
  return (
    ...
    <div className="flex w-[58%] h-fit m-auto gap-4 my-[80px]">
      ...
      <div className="w-[50%]">
        <h1 className="font-antonio text-white text-center text-7xl py-8">{PlanetName}</h1>
        <p className="text-white mx-[100px] text-center leading-6 text-sm">
          {PlanetAbout}
        </p>
        <div className="flex justify-center">
          <p className="flex gap-2 text-white my-[25px] text-sm">Source : 
            <a className="underline font-bold" href={PlanetWikipedia}>Wikipedia</a>
            <img src={shape}/>
          </p>
        </div>
    ...
    <div className="flex text-white w-full justify-center gap-x-7">
      <div className="border w-[255px] h-32">
        ...
        <h1 className="text-white font-antonio text-[35px] px-5">{RotationTime}</h1>
      </div>
      <div className="border w-[255px] h-32">
        <p className="text-xs font-headerFont opacity-[50%] py-5 px-6">REVOLUTION TIME</p>
        <h1 className="text-white font-antonio text-[35px] px-5">{RevolutionTIme}</h1>
      </div>
      <div className="border w-[255px] h-32">
      ...
      <div className="border w-[255px] h-32">
        ...
        <h1 className="text-white font-antonio text-[35px] px-5">{Average}</h1>
      </div>
      </div>    
    </>
  );
